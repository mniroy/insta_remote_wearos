...
import com.arashivision.sdk.demo.ui.osc.OscProtocolActivity
import com.arashivision.sdk.demo.ui.shot.ShotActivity
import com.arashivision.sdk.demo.ui.upgrade.FwUpgradeActivity
import com.arashivision.sdk.demo.ui.wifi.WiFiSettingActivity
...
class AbilityFragment : BaseFragment<FragmentAbilityBinding, AbilityViewModel>() {
    ...
    override fun initListener() {
        ...
        binding.tvWifiSetting.setOnClickListener {
            activity?.let { startActivity(Intent(it, WiFiSettingActivity::class.java)) }
        }

        binding.tvOscProtocol.setOnClickListener {
            activity?.let { startActivity(Intent(it, OscProtocolActivity::class.java)) }
        }
    }
    ...
    private fun updateUi(enable: Boolean, connectType: Int) {
        ...
        binding.tvWifiSetting.isEnabled = enable
        binding.tvOscProtocol.isEnabled = enable
