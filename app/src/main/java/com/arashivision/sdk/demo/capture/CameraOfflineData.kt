...
class CameraOfflineData {
    ...
    init {
        // 初始化拍摄模式并矫正
        currentCaptureMode = instaCameraManager.currentCaptureMode ?: CaptureMode.CAPTURE_NORMAL
    ...
    private fun setCaptureSetting(captureMode: CaptureMode, captureSetting: CaptureSetting, value: Any, checker: ((checks: List<CaptureSetting>) -> Unit)? = null) {
