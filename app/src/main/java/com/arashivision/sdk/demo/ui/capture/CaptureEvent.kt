...
interface CaptureEvent : BaseEvent {
    ...
    data class InitCaptureEvent(
        ...
        var isSingleClickAction: Boolean? = null
    ) : CaptureEvent

    data class SwitchCaptureModeEvent(var status: EventStatus, var captureMode: CaptureMode? = null, val isSingleClickAction: Boolean? = null) : CaptureEvent

    object CameraPreviewStreamParamsChangedEvent : CaptureEvent

    data class RestartPlayerViewEvent(val onFinish: (() -> Unit)? = null) : CaptureEvent
    ...
    class CameraCaptureEvent(
        ...
        var isSingleClickAction: Boolean,
    ...
    object ReopenPreviewStreamEvent : CaptureEvent

    object CameraPreviewStreamClosed : CaptureEvent

    class UpdateRemainingEvent(val captureMode: CaptureMode, val remaining: Int, val freeSpace: Long) : CaptureEvent
}
